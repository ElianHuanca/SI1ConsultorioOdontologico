					...
					<div class="col justify-content-center">
						...
						<div class="row justify-content-between mx-1 mb-2">
							<div class="col justify-content-center">
								...
								<div class="row align-items-center justify-content-between">
									<div class="col-4">
										<h6>Telefono: 3526482</h6>
									</div>
									<div class="col-4" style="float:right">
										<h6>Nro Factura: {{$factura->id}}</h6>
									</div>
								</div>
								<div class="row align-items-center justify-content-between">
									<div class="col-4">
				...
				<div class="row justify-content-center border border-primary  border-top-0 border-bottom-0">
					<div class="col justify-content-center">
						...
						<div class="row  align-items-center justify-content-between">
							<div class="col-4">
								<h6>Fecha de Emision:
									<h6 class="font-weight-normal">{{$factura->fecha}}</h6>
								</h6>
							</div>
							<div class="col-4" style="float:right">
								<h6>NIT:
									<h6 class="font-weight-normal">{{$factura->nit}}</h6>
								</h6>
							</div>
						</div>
						...
						<div class="row  align-items-center justify-content-between">
							<div class="col-4">
								<h6>Señor(es):
									<h6 class="font-weight-normal">{{$factura->nombre}}</h6>
								</h6>
							</div>
							<div class="col-4" style="float:right">
								<h6>Codigo Paciente:
									<h6 class="font-weight-normal">{{$pacienteId}}</h6>
								</h6>
							</div>
						</div>
						<div class="row  align-items-center justify-content-between">
							<div class="col-4">
								<h6>Nro de Pago:
									<h6 class="font-weight-normal">{{$factura->pago_id}}</h6>
								</h6>
							</div>
							<div class="col-4" style="float:right">
								<h6>Categoria:
